...
namespace WATA.LIS.VISION.CAM.Camera
{
    public class HIKVISION : System.Windows.Window
    {
        ...
        private const string detectorPrototxtPath = @"C:\Users\wata_iot_dev\Source\Repos\LIS-ForkLift_mswon\WATA.LIS\Modules\WATA.LIS.VISION.CAM\Model\detect.prototxt";
        private const string detectorCaffeModelPath = @"C:\Users\wata_iot_dev\Source\Repos\LIS-ForkLift_mswon\WATA.LIS\Modules\WATA.LIS.VISION.CAM\Model\detect.caffemodel";
        private const string superResolutionPrototxtPath = @"C:\Users\wata_iot_dev\Source\Repos\LIS-ForkLift_mswon\WATA.LIS\Modules\WATA.LIS.VISION.CAM\Model\sr.prototxt";
        private const string superResolutionCaffeModelPath = @"C:\Users\wata_iot_dev\Source\Repos\LIS-ForkLift_mswon\WATA.LIS\Modules\WATA.LIS.VISION.CAM\Model\sr.caffemodel";
        private WeChatQRCode m_WeChatQRCode = WeChatQRCode.Create(detectorPrototxtPath, detectorCaffeModelPath, superResolutionPrototxtPath, superResolutionCaffeModelPath);
        ...
        private void GetFrame(object sender, EventArgs e)
        {
            try
            {
                ...
                //Cv2.PutText(resizedFrame, $"FPS: {_fps:F2}", new OpenCvSharp.Point(10, 100), HersheyFonts.HersheySimplex, 1, Scalar.Red, 3);
                //Cv2.PutText(resizedFrame, $"GET QR: {_getqr:F2} ms", new OpenCvSharp.Point(10, 200), HersheyFonts.HersheySimplex, 1, Scalar.Red, 3);
