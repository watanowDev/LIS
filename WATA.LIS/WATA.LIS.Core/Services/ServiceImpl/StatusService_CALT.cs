...
namespace WATA.LIS.Core.Services
{
    ...
    public class StatusService_CALT : IStatusService
    {
        ...
        public StatusService_CALT(IEventAggregator eventAggregator, IMainModel main, IRFIDModel rfidmodel, IVisionModel visionModel)
        {
